        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <div id="page-content">
					...
					<!-- QUICK TIPS -->
					<!-- ==================================================================== -->
					<h2>Вы на странице управления ролями пользователей</h2>
                    <h3>Список модераторов</h3>
                    <?php
                    if ($moders == NULL) {
                        ?>
                        <p>Список модераторов пуст.</p>
                        <?php
                    } else {
                        ?>
    					        ...
    					        <tbody>
                                    ...
                                    foreach ($moders as $item) {
                                        ...
                                        <tr>
        					                ...
        					                <td><a href="/admin/endmoder/<?php echo  $item['id']; ?>/" class="btn btn-info">Снять модератора</a></td>
        					            </tr>
                                        <?php
                                    }
                                    ?>
    					        ...
    					        <tbody>
                                    ...
                                    foreach ($allUsers as $item) {
                                        ...
                                        <tr>
        					                ...
        					                <td>
                                                <a href="/admin/addmoder/<?php echo  $item['tg-id']; ?>/" class="btn btn-info">
