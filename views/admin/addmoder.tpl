...
<head>
    ...
    <link href="/templates/admin/css/mystyles.css" rel="stylesheet">
        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Работа с ролями</li>
                </ol>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End breadcrumb-->
                ...
                <div id="page-content">
					...
					<!-- QUICK TIPS -->
					<!-- ==================================================================== -->
					<h2>Назначение модератором пользователя</h2>
                    <h3>Вы собираетесь назначить пользователя <?php echo  $userInfo["firstname"]; ?> модератором</h3>
                    <?php
                    if ($userInfo == NULL) {
                        ?>
                        ...
                        <div class="table-responsive">
    					    <table class="table">
    					        <tbody>
                                    ...
                                    <tr>
        					            <td><?php echo  $userInfo["tg-login"]; ?></td>
        					            <td><?php echo  $userInfo["firstname"]; ?></td>
        					        </tr>
    					        </tbody>
    					    </table>
    					</div>
                        <div class="stand-input">
                            <?php
                            if ($userInfo["status"] == 0) {
                            ?>
                                <h3>Для этого нужно задать ему логин и пароль</h3>
                                <?php
                                if (isset($_SESSION['checkUsrWrong'])) {
                                    ?>
                                    <p class="check-usr-wrong"><?php echo  $_SESSION['checkUsrWrong']; ?></p>
                                    <?php
                                    unset($_SESSION['checkUsrWrong']);
                                }
                                ?>
                                <form action="/admin/addmoder/<?php echo  $userInfo['tg-id']; ?>/" method="POST">
                                    <div class="form-group">
                                        <label for="loginInput">Логин</label>
                                        <input type="input" class="form-control" id="loginInput" name="login" aria-describedby="loginHelp" placeholder="Enter login">
                                        <small id="loginHelp" class="form-text text-muted">
                                            Используйте строчные или заглавные латинские буквы и цифры.
                                        </small>
                                    </div>
                                    <div class="form-group">
                            ...
                            ?>
                                <h3>Данный пользователь назначен модератором</h3>
                            <?php
                            }
                            ?>
                        </div>
