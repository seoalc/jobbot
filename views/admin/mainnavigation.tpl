            ...
            <div class="nano">
                <div class="nano-content">
                    ...
                    <div id="mainnav-profile" class="mainnav-profile">
                        <div class="profile-wrap">
                            <div class="pad-btm">
                                ...
                                <img class="img-circle img-sm img-border" src="/templates/img/profile-photos/1.png" alt="Profile Picture">
                            </div>
                    ...
                    <ul id="mainnav-menu" class="list-group">
                        ...
                        <!--Category name-->
                        <li class="list-header">Категории</li>

                        <!--Menu list item-->
                        <li class="active-link">
                            <a href="/admin/viewonecomp/">
                                <i class="psi-hotel"></i>
                        ...
                        <!--Menu list item-->
                        <li>
                            <a href="/admin/viewoneempl/">
                                <i class="psi-laptop-2"></i>
