        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="/admin/viewonecomp/<?php echo  $compInfo['id']; ?>/">Компания <?php echo  $compInfo["company-name"]; ?></a></li>
                    <li class="active">Вакансия <?php echo  $emplInfo["career-objective"]; ?></li>
                </ol>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End breadcrumb-->
                ...
                <div id="page-content">
					...
					<!-- QUICK TIPS -->
					<!-- ==================================================================== -->
					<h2>Вы на странице работы с одной вакансией</h2>
                    <?php
                    if ($emplInfo == Null) {
                        ?>
                        <p>Такая вакансия не найдена.</p>
                        <?php
                    } else {
                        ?>
    					    ...
    					    <table class="table">
    					        <tbody>
                                    <tr>
    					                ...
    					                <th>Должность</th>
    					                <th>Зарплата</th>
    					                <th>Возможность удаленной работы</th>
    					                <th>Тип занятости</th>
    					                <th>Обязанности</th>
                                    ...
                                    <tr>
        					            <td><?php echo  $emplInfo["tg-login"]; ?></td>
        					            <td><a href="/admin/viewonecomp/<?php echo  $compInfo['id']; ?>/"><?php echo  $compInfo["company-name"]; ?></a></td>
        					            <td><?php echo  $emplInfo["career-objective"]; ?></td>
        					            <td><?php echo  $emplInfo["desired-salary"]; ?></td>
        					            <td><?php echo  $emplInfo["workformat"]; ?></td>
        					            <td><?php echo  $emplInfo["employment"]; ?></td>
        					            <td><?php echo  $emplInfo["duties"]; ?></td>
        					            <td><?php echo  $emplInfo["requirements"]; ?></td>
        					            <td><?php echo  $emplInfo["working-conditions"]; ?></td>
        					        </tr>
    					        </tbody>
    					    </table>
    					</div>
