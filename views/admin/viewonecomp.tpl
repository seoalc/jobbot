        ...
        <div class="boxed">
            ...
            <div id="content-container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Компания <?php echo  $compInfo["company-name"]; ?></li>
                </ol>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End breadcrumb-->
                ...
                <div id="page-content">
					...
					<!-- QUICK TIPS -->
					<!-- ==================================================================== -->
					<h2>Вы на странице работы с одной компанией</h2>
                    <?php
                    if ($compInfo == Null) {
                        ?>
                        <p>Такая компания не найдена.</p>
                        <?php
                    } else {
                        ?>
                        <div class="table-responsive">
    					    <table class="table">
    					        <tbody>
                                    ...
                                    <tr>
        					            <td><?php echo  $compInfo["company-name"]; ?></td>
        					            <td><?php echo  $compInfo["tg-login"]; ?></td>
        					            <td><?php echo  $compInfo["line-business"]; ?></td>
        					            <td><?php echo  $compInfo["city"]; ?></td>
        					        </tr>
    					        </tbody>
    					    </table>
    					</div>
                    ...
                    if ($compEmpls == Null) {
                        ?>
                        <p>Вакансии данной компании не найдены.</p>
                        <?php
                    } else {
                        ?>
                        <div class="table-responsive">
    					    <table class="table">
    					        <tbody>
                                    ...
                                    <?php
                                    foreach ($compEmpls as $item) {
                                        ?>
                                        <tr>
        					                <td><?php echo  $item["career-objective"]; ?></td>
        					                <td><?php echo  $item["desired-salary"]; ?></td>
        					                <td><?php echo  $item["duties"]; ?></td>
        					                <td><a href="/admin/viewoneempl/<?php echo  $item['id']; ?>/" class="btn btn-info">Смотреть полностью</a></td>
        					            </tr>
                                        <?php
                                    }
                                    ?>
